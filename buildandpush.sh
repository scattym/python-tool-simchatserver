...
if [ "X${version}" != "X" ] ; then
    ...
    docker build --tag=gcr.io/geotool-test/mqrecv-mt-file:v${version} . -f dockerfiles/mqrecv-mt-file/Dockerfile
    docker build --tag=gcr.io/geotool-test/meitrackbot:v${version} . -f dockerfiles/meitrackbot/Dockerfile
    ...
    if [ $? -eq 0 ] ; then
        ...
        gcloud docker -- push gcr.io/geotool-test/mqrecv-mt-file:v${version}
        gcloud docker -- push gcr.io/geotool-test/meitrackbot:v${version}
        ...
        docker tag gcr.io/geotool-test/mqrecv-mt-file:v${version} gcr.io/position-live/mqrecv-mt-file:v${version}
        docker tag gcr.io/geotool-test/meitrackbot:v${version} gcr.io/position-live/meitrackbot:v${version}
        ...
        gcloud docker -- push gcr.io/position-live/mqrecv-mt-file:v${version}
        gcloud docker -- push gcr.io/position-live/meitrackbot:v${version}
